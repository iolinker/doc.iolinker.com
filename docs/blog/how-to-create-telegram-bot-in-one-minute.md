...
After creating the credentials, navigate to the **App Development > Credential Management** page in IOLinker and enter the Telegram credentials you just created:
