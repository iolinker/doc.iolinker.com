...
- **Credential** (Required): Select a Kafka credential. You can create a Kafka credential type in the **App Development > Credential** section with the following configuration:
