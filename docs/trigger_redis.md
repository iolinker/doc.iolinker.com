...
- **Credential** (Required): Select a Redis credential. You can create a Redis credential type in the **App Development > Credential** section with the following configuration:
