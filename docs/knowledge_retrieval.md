...
- **LLM Credential**: Select an LLM API Key credential. The embedding model from this provider will be used to vectorize the document content. You can create an LLM API Key credential in the **App Development > Credential** section.
