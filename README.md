...
- [Mac Apple](https://github.com/iolinker/iolinker.com/releases/download/v1.2.7/iolinker-standalone-darwin-arm64-v1.2.7.tar.gz)
...
- [Raspberry PI 4B](https://github.com/iolinker/iolinker.com/releases/download/v1.2.7/iolinker-standalone-linux-armv7-v1.2.7.tar.gz)
- [Synology NAS](https://github.com/iolinker/iolinker.com/releases/download/v1.2.7/iolinker-standalone-linux-armv7-v1.2.7.tar.gz)
- [Docker]
```
